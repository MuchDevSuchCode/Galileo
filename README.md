...
- **Open** — folders navigate in; images open in the photo viewer; **audio & video open in the embedded player**; other files open in their default app. **Slideshow** and **Collage** buttons act on the current folder's images. Single- or double-click to open (configurable).
