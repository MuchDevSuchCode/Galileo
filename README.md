...
- **Per-vault sharing** — inside an unlocked vault, click the **Share** icon in the command bar and toggle **which friends** get it (not everyone, not everything). Revoking takes effect live. While you're inside a vault, a small **Online / Offline** indicator (green / red orb) in the footer shows whether you're reachable on the relay to serve shares.
